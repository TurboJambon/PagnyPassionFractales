...
/*   Updated: 2017/06/05 18:57:31 by dchirol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_zoom(int x, int y, t_env *e)
{
	...
	e->p1.x = new_x - ((new_x - e->p1.x) * 0.6);
	e->p2.x = new_x + ((e->p2.x - new_x) * 0.6);
	e->p1.y = new_y - ((new_y - e->p1.y) * 0.6);
	e->p2.y = new_y + ((e->p2.y - new_y) * 0.6);
	e->move_x *= 1.6;
	e->move_y *= 1.6;
}
